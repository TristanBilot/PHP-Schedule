...
--
-- Hôte : localhost:3306
-- Généré le :  mer. 21 nov. 2018 à 21:50
...
(17, 1542240000, 'Tristan Bilot', 1),
(18, 1541635200, 'Test Auto increment', 1),
(19, 1542240000, 'TEST', 1),
(20, 1542240000, 'TEST', 1),
(21, 1543449600, 'Test label', 0),
(22, 1543449600, 'Test label', 0),
(23, 1543017600, 'Tristan Bilot', 1),
(24, 1542240000, 'Test Auto increment', 1);
...
INSERT INTO `etudiant` (`id_etu`, `id_promo`, `id_grpe`, `genre`, `nom`, `prenom`, `email`, `login_etu`, `pass_etu`, `matricule`, `date_etu`, `urlPhoto`, `bConnect`, `notif`) VALUES
...
(2, 1, 1, 'M', 'Karl', 'Bernard', 'bernard.karl@parisdescartes.fr', 'bkarl', '*B64D2DC5BB06AEAD6D5F0DBC01F6FB8D6AC6CA00', '40004000', '2018-09-10', '', 0, 1),
(3, 1, 2, 'Melle', 'Mozart', 'santa cruz', 'lea.mozart@parisdescartes.fr', 'lmozart', '*3D0D46868FDDF27F76B5F10DE31DB98318493F0D', '10001000', '2018-09-10', '', 0, 0),
...
(10, 1, 2, 'M', 'test', 'test', 'test@', 'test', 'test', '20000', '2018-09-10', '', 0, 1);
...
(1, 1, 1, 1, 'Programmation WEB côté Serveur (M3104)', 'mon cours', '#009688', '{\n\"web\":\"Client Serveur HTTP\", \n\"pattern\":\"MVC\",\n\"Langage\":\"PHP\"\n}\n', '{\"A\":[\"mono\",4.5],\"M\":[\"bi\",3]}'),
(2, 1, 1, 2, 'Programmation WEB côté Serveur - JAVA (M3104-2)', 'PWEB JAVA', '#795548', '{\n\"Systeme WEB\":\"Client Serveur HTTP\", \n\"Langage\":\"JAVA\"\n}\n', '{\n\"A\":[\"promo\",1.5],\n\"M\":[\"bi\",3]\n}'),
(9, 1, 1, 1, 'Algorithmique avancée', 'AAV', '', '{\"complexite\": \"tri\"}', '{\n\"A\":[\"promo\",1.5],\n\"T\":[\"bi\",1.5],\n\"M\":[\"mono\",1.5]\n}'),
(14, 2, 1, 1, 'Anglais', 'ANG', '#009688', 'vocabulaire', '{\"M\":[\"mono\",1.5]}'),
...
(1, 1, 2, 5, 'Bonjour'),
(2, 1, 2, 5, 'test'),
(3, 1, 2, 6, 'Ce message est un test'),
(4, 1, 2, 6, 'Salut'),
(5, 1, 8, 2, 'Coucou'),
(6, 1, 8, 2, 'Ce message est un test');
...
(2, 'M', 'Ilié', 'Jean-Michel', 'jmilie@parisdescartes.fr', 'JMI', 'jmilie', 'test', '2018-09-12', './V/utilisateur/images/jean mich.jpg', '#e91e63', 1),
(3, 'M', 'Foughali', 'Karim', 'kfoughali@gmail.com', 'KF', 'kfoughali', 'ecf66de73808530b5e5dc5462cfd074d085fa89c', '2018-01-12', '', '#00bcd4', 0),
...
(6, 'M', 'Ouziri', 'Mourad', 'mouziri@parisdescartes.fr', 'MO', 'mouziri', '*F07FBB4086D1DF19106B375B6E5D7A11BB485C2E', '2018-09-10', '', '', 1),
(7, 'Mme', 'Dirani', 'Hélène', 'hdirani@parisdescartes.fr', 'HD', 'hdirani', '*81DD599CAA08EA3C67AB17DD86AB3094216B1EC4', '2018-09-10', '', '', 0),
(8, 'M', 'Poitrenaud', 'Denis', 'dpoitrenaud', 'DP', 'dpoitrenaud', 'dpoitrenaud', '2018-09-10', '', '#3f51b5', 1),
...
--
ALTER TABLE `edth`
  MODIFY `id_edth` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
